function out = formulation(ps_drone, pe_drone, t_start, t_end, time_horizon_, px_windmill, py_windmill, r_windmill, v_initial, a_initial)
...
% Minimize the accelerations equal to zero
r = [0.0 0.0 0.0];
