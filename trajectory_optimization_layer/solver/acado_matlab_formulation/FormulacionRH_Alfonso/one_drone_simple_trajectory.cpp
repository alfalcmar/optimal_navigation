...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_v1(0) = 2.964616E+00;
    acadodata_v1(1) = 9.009573E+00;
    ...
    acadodata_v2(0) = 1.429046E-03;
    acadodata_v2(1) = -4.373800E-04;
    acadodata_v2(2) = 7.078895E-06;
    acadodata_v2(3) = 0;
    DVector acadodata_v3(4);
    acadodata_v3(0) = 1.429046E-03;
    acadodata_v3(1) = -4.373800E-04;
    acadodata_v3(2) = 7.078895E-06;
    acadodata_v3(3) = 0;
    ...
    OCP ocp1(52.8, 60, 18);
    ocp1.minimizeLagrangeTerm(pow(((-6.50006795917875734858e+00+pz_)/sqrt((1.00000000000000008180e-05+pow((-1.20000000000000000000e+01+px_),2.00000000000000000000e+00)+pow((-1.60000000000000000000e+01+py_),2.00000000000000000000e+00)))-1.00000000000000005551e-01),2.00000000000000000000e+00));
    ...
    ocp1.subjectTo((-2.00000000000000000000e+00) <= vx_ <= 2.00000000000000000000e+00);
    ocp1.subjectTo((-2.00000000000000000000e+00) <= vy_ <= 2.00000000000000000000e+00);
    ocp1.subjectTo((-8.00000000000000044409e-01) <= vz_ <= 8.00000000000000044409e-01);
    ocp1.subjectTo((-8.00000000000000044409e-01) <= vz_ <= 8.00000000000000044409e-01);
    ocp1.subjectTo(1.50000000000000000000e+00 <= (-6.50006795917875734858e+00+pz_+s));
    ocp1.subjectTo(s >= 0.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, px_ == 1.04252927993813609975e-01);
    ocp1.subjectTo(AT_START, py_ == 1.63951968891245307702e+01);
    ocp1.subjectTo(AT_START, pz_ == 8.56403515257578895614e+00);
    ocp1.subjectTo(AT_START, vx_ == 1.63561782767000479799e-01);
    ocp1.subjectTo(AT_START, vy_ == (-9.30525661508958656931e-01));
    ocp1.subjectTo(AT_START, vz_ == 9.73550455122142999187e-02);
    ocp1.subjectTo(AT_START, ax_ == 9.29473095724671488638e-02);
    ocp1.subjectTo(AT_START, ay_ == (-3.35452670115357898251e-02));
    ocp1.subjectTo(AT_START, az_ == 2.29896771796932811172e-02);
