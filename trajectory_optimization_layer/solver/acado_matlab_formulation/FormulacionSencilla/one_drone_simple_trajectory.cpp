...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-1.50000000000000000000e+01) <= vz_ <= 1.50000000000000000000e+01);
    ocp1.subjectTo(AT_START, px_ == (-2.00000000000000000000e+00));
    ocp1.subjectTo(AT_START, py_ == (-4.00000000000000000000e+00));
    ocp1.subjectTo(AT_START, pz_ == 8.00000000000000000000e+00);
    ocp1.subjectTo(AT_START, vx_ == (-9.56751148652851490795e-01));
    ocp1.subjectTo(AT_START, vy_ == (-1.15754251864900381541e+00));
    ocp1.subjectTo(AT_START, vz_ == 4.72056989013766095664e-02);
    ocp1.subjectTo(AT_START, ax_ == (-4.96219673644190668697e-04));
    ocp1.subjectTo(AT_START, ay_ == (-5.64525401490223303382e-04));
    ocp1.subjectTo(AT_START, az_ == (-1.54708125600840881763e-04));
    ocp1.subjectTo((pow((-1.20000000000000000000e+01+px_),2.00000000000000000000e+00)+pow((-1.60000000000000000000e+01+py_),2.00000000000000000000e+00)) >= 9.00000000000000000000e+00);
