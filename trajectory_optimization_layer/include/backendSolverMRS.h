...
private:
  ...
  ros::ServiceServer service_for_trajectory_following_activation;
  ...
  bool trajectoryFollowingStartServiceCallback(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res);
